...
attribute_subtype!(SpellSchool, (Evocation "Evocation"), (Illusion "Illusion"), (Conjuration "Conjuration"), (Abjuration "Abjuration"), (Enchantment "Enchantment"), (Transmutation "Transmutation"));
